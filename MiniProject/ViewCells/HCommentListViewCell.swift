...
//                        cSize = CGSize(width: cWidth, height: cWidth)
    ...
    //                contentCell.setState(t: data.t_s)
                    ...
                    let contentCell = PostQuoteContentCell(frame: CGRect(x: 0, y: 0, width: availableWidth, height: 120.0)) //120 => dummy, will be overriden
