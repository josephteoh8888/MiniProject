//
//  HResultPhotoListViewCell.swift
//  MiniProject
//
...
//        aResult.layer.cornerRadius = 10
        ...
        gifImage.heightAnchor.constraint(equalToConstant: 75).isActive = true
        ...
        contentText.topAnchor.constraint(equalTo: gifImage.topAnchor, constant: 10).isActive = true //10
...
//        contentText.trailingAnchor.constraint(equalTo: aResult.trailingAnchor, constant: -20).isActive = true //-30
        contentText.trailingAnchor.constraint(equalTo: aResult.trailingAnchor, constant: -20).isActive = true //-30
        contentText.text = "Vấn đề đã rõ, đã chín, được thực tiễn chứng minh là đúng, thực hiện hiệu quả, đa số đồng tình thì tiếp tục thực hiện"
