...
//    func didStartMePostPanGesture(ppv : MePostListPanelView)
//    func didEndMePostPanGesture(ppv : MePostListPanelView)
//    func didStartOpenMePostPanel()
//    func didFinishOpenMePostPanel()
//    func didStartCloseMePostPanel(ppv : MePostListPanelView)
//    func didFinishCloseMePostPanel(ppv : MePostListPanelView)
//}
////test > new method with uiscrollview of feedcells
//class MePostListPanelView: PanelView, UIGestureRecognizerDelegate{
////    var panelLeadingCons: NSLayoutConstraint?
////    var currentPanelLeadingCons : CGFloat = 0.0
//    var panel = UIView()
//    var tabDataList = [String]()
//    
//    weak var delegate : MePostPanelDelegate?
//    
...
//            if let c = feed as? ScrollFeedHResultPostListCell {
//                c.dehideCell()
//            }
//        }
//    }
...
//
//            if(dist >= distLimit) {
//                self.delegate?.didStartCloseMePostPanel(ppv: self)
//
//            } else {
//                let oriX = width/2 - height/2 //default 200
//                let oriY = viewHeight/2 - height/2
...
//
//                //test
//                self.delegate?.didEndMePostPanGesture(ppv: self)
//            }
//            
//            //test > determine direction of scroll
//            direction = "na"
...
//
//                self.delegate?.didFinishCloseMePostPanel(ppv : self)
//            })
//        } else {
//            //test > stop video before closing panel
//            self.destroyCell()
...
//
//        if(isAnimated) {
//            self.delegate?.didStartOpenMePostPanel()
//
//            offsetX = offX
//            offsetY = offY
//
...
//                
//            }, completion: { finished in
//                self.delegate?.didFinishOpenMePostPanel()
//
//                //test
//                self.initialize()
//            })
...
//                        feed.setFooterAaText(text: "No post created yet.")
...
//}
//
//extension MePostListPanelView: UIScrollViewDelegate {
//    
...
//}
//
//extension MePostListPanelView: ScrollFeedCellDelegate {
...
//}
//
//extension MePostListPanelView: TabStackDelegate {
