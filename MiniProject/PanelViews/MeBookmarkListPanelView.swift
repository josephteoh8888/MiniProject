...
//    func didStartMeBookmarkPanGesture(ppv : MeBookmarkListPanelView)
//    func didEndMeBookmarkPanGesture(ppv : MeBookmarkListPanelView)
//    func didStartOpenMeBookmarkPanel()
//    func didFinishOpenMeBookmarkPanel()
//    func didStartCloseMeBookmarkPanel(ppv : MeBookmarkListPanelView)
//    func didFinishCloseMeBookmarkPanel(ppv : MeBookmarkListPanelView)
//}
////test > new method with uiscrollview of feedcells
//class MeBookmarkListPanelView: PanelView, UIGestureRecognizerDelegate{
////    var panelLeadingCons: NSLayoutConstraint?
////    var currentPanelLeadingCons : CGFloat = 0.0
//    var panel = UIView()
//    var tabDataList = [String]()
//    
//    weak var delegate : MeBookmarkPanelDelegate?
//    
...
//
//            if(dist >= distLimit) {
//                self.delegate?.didStartCloseMeBookmarkPanel(ppv: self)
//
//            } else {
//                let oriX = width/2 - height/2 //default 200
//                let oriY = viewHeight/2 - height/2
...
//
//                //test
//                self.delegate?.didEndMeBookmarkPanGesture(ppv: self)
//            }
//            
//            //test > determine direction of scroll
//            direction = "na"
...
//
//                self.delegate?.didFinishCloseMeBookmarkPanel(ppv : self)
//            })
//        } else {
//            //test > stop video before closing panel
//            self.destroyCell()
...
//
//        if(isAnimated) {
//            self.delegate?.didStartOpenMeBookmarkPanel()
//
//            offsetX = offX
//            offsetY = offY
//
...
//                
//            }, completion: { finished in
//                self.delegate?.didFinishOpenMeBookmarkPanel()
//
//                //test
//                self.initialize()
//            })
...
//}
//
//extension MeBookmarkListPanelView: UIScrollViewDelegate {
//    
...
//}
//
//extension MeBookmarkListPanelView: ScrollFeedCellDelegate {
...
//}
//
//extension MeBookmarkListPanelView: TabStackDelegate {
