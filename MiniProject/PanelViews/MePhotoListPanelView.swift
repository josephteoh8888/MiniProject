...
//    func didStartMePhotoPanGesture(ppv : MePhotoListPanelView)
//    func didEndMePhotoPanGesture(ppv : MePhotoListPanelView)
//    func didStartOpenMePhotoPanel()
//    func didFinishOpenMePhotoPanel()
//    func didStartCloseMePhotoPanel(ppv : MePhotoListPanelView)
//    func didFinishCloseMePhotoPanel(ppv : MePhotoListPanelView)
//}
////test > new method with uiscrollview of feedcells
//class MePhotoListPanelView: PanelView, UIGestureRecognizerDelegate{
////    var panelLeadingCons: NSLayoutConstraint?
////    var currentPanelLeadingCons : CGFloat = 0.0
//    var panel = UIView()
//    var tabDataList = [String]()
//    
//    weak var delegate : MePhotoPanelDelegate?
//    
...
//
//            if(dist >= distLimit) {
//                self.delegate?.didStartCloseMePhotoPanel(ppv: self)
//
//            } else {
//                let oriX = width/2 - height/2 //default 200
//                let oriY = viewHeight/2 - height/2
...
//
//                //test
//                self.delegate?.didEndMePhotoPanGesture(ppv: self)
//            }
//            
//            //test > determine direction of scroll
//            direction = "na"
...
//
//                self.delegate?.didFinishCloseMePhotoPanel(ppv : self)
//            })
//        } else {
//            //test > stop video before closing panel
//            self.destroyCell()
...
//
//        if(isAnimated) {
//            self.delegate?.didStartOpenMePhotoPanel()
//
//            offsetX = offX
//            offsetY = offY
//
...
//                
//            }, completion: { finished in
//                self.delegate?.didFinishOpenMePhotoPanel()
//
//                //test
//                self.initialize()
//            })
...
//}
//
//extension MePhotoListPanelView: UIScrollViewDelegate {
//    
...
//}
//
//extension MePhotoListPanelView: ScrollFeedCellDelegate {
...
//}
//
//extension MePhotoListPanelView: TabStackDelegate {
