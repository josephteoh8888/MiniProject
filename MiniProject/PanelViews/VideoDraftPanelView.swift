...
protocol VideoDraftPanelDelegate : AnyObject {
...
extension VideoDraftPanelView: UICollectionViewDelegateFlowLayout {
...
extension VideoDraftPanelView: UICollectionViewDataSource {
...
extension ViewController: VideoDraftPanelDelegate{
    func didClickCloseVideoDraftPanel() {
