...
protocol PostDraftPanelDelegate : AnyObject {
    func didClickClosePostDraftPanel()
}

class PostDraftPanelView: PanelView, UIGestureRecognizerDelegate{
...
//    var currentPanelLeadingCons : CGFloat = 0.0
    ...
    weak var delegate : PostDraftPanelDelegate?
...
//        panelTitleText.font = .systemFont(ofSize: 14) //default 14
        ...
        panelTitleText.text = "Post Drafts"
        ...
        if(gesture.state == .began) {
            ...
            if(self.currentPanelTopCons - self.panelTopCons!.constant < -150) {
                UIView.animate(withDuration: 0.2, animations: {
                    ...
                    self.delegate?.didClickClosePostDraftPanel()
                })
            } else {
                UIView.animate(withDuration: 0.2, animations: {
...
extension PostDraftPanelView: UICollectionViewDelegateFlowLayout {
...
extension PostDraftPanelView: UICollectionViewDataSource {
...
extension PostDraftPanelView: UICollectionViewDelegate {
...
extension ViewController: PostDraftPanelDelegate{
    func didClickClosePostDraftPanel() {
