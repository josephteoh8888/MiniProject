...
//    func didStartMeLocationPanGesture(ppv : MeLocationListPanelView)
//    func didEndMeLocationPanGesture(ppv : MeLocationListPanelView)
//    func didStartOpenMeLocationPanel()
//    func didFinishOpenMeLocationPanel()
//    func didStartCloseMeLocationPanel(ppv : MeLocationListPanelView)
//    func didFinishCloseMeLocationPanel(ppv : MeLocationListPanelView)
//}
////test > new method with uiscrollview of feedcells
//class MeLocationListPanelView: PanelView, UIGestureRecognizerDelegate{
...
//
//            if(dist >= distLimit) {
//                self.delegate?.didStartCloseMeLocationPanel(ppv: self)
//
//            } else {
//                let oriX = width/2 - height/2 //default 200
//                let oriY = viewHeight/2 - height/2
...
//
//                //test
//                self.delegate?.didEndMeLocationPanGesture(ppv: self)
//            }
//            
//            //test > determine direction of scroll
//            direction = "na"
...
//
//                self.delegate?.didFinishCloseMeLocationPanel(ppv : self)
//            })
//        } else {
//            //test > stop video before closing panel
//            self.destroyCell()
...
//
//        if(isAnimated) {
//            self.delegate?.didStartOpenMeLocationPanel()
//
//            offsetX = offX
//            offsetY = offY
//
...
//                
//            }, completion: { finished in
//                self.delegate?.didFinishOpenMeLocationPanel()
//
//                //test
//                self.initialize()
//            })
