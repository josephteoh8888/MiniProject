...
//                        vData.setData(data: i)
//                        vData.setTextString(data: i)
////                        feed.vcDataList.append(vData) //cannot append as index 0 is still loading screen
//                        tempDataList.append(vData)
//                    }
//                    feed.vcDataList.insert(contentsOf: tempDataList, at: 0)
//                    
//                    feed.videoCV?.reloadData()
//                    
//                    //test 3 > new method => tried, but need to remove the loading spinner at index 0
////                    let dataCount = feed.vcDataList.count
////                    var indexPaths = [IndexPath]()
////                    var j = 0
////                    var tempDataList = [VideoData]()
////                    for i in l {
