...
//    
//    func didStartMeLikePanGesture(ppv : MeLikeListPanelView)
//    func didEndMeLikePanGesture(ppv : MeLikeListPanelView)
//    func didStartOpenMeLikePanel()
//    func didFinishOpenMeLikePanel()
//    func didStartCloseMeLikePanel(ppv : MeLikeListPanelView)
//    func didFinishCloseMeLikePanel(ppv : MeLikeListPanelView)
//}
////test > new method with uiscrollview of feedcells
//class MeLikeListPanelView: PanelView, UIGestureRecognizerDelegate{
...
//
//            if(dist >= distLimit) {
//                self.delegate?.didStartCloseMeLikePanel(ppv: self)
//
//            } else {
//                let oriX = width/2 - height/2 //default 200
//                let oriY = viewHeight/2 - height/2
...
//
//                //test
//                self.delegate?.didEndMeLikePanGesture(ppv: self)
//            }
//            
//            //test > determine direction of scroll
//            direction = "na"
...
//
//                self.delegate?.didFinishCloseMeLikePanel(ppv : self)
//            })
//        } else {
//            //test > stop video before closing panel
//            self.destroyCell()
...
//
//        if(isAnimated) {
//            self.delegate?.didStartOpenMeLikePanel()
//
//            offsetX = offX
//            offsetY = offY
//
...
//                
//            }, completion: { finished in
//                self.delegate?.didFinishOpenMeLikePanel()
//
//                //test
//                self.initialize()
//            })
