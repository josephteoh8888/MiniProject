...
//        self.addSubview(cameraView)
        ...
        startRecordingBtn.backgroundColor = .yellow //white
...
//        lhsMiniError.isHidden = true
        ...
        lhsMiniAdd.backgroundColor = .white
        ...
        lhsMiniAdd.heightAnchor.constraint(equalToConstant: 20).isActive = true
        lhsMiniAdd.widthAnchor.constraint(equalToConstant: 20).isActive = true
        lhsMiniAdd.layer.cornerRadius = 10
        
        let lhsAddBtn = UIImageView(image: UIImage(named:"icon_round_add")?.withRenderingMode(.alwaysTemplate))
        lhsAddBtn.tintColor = .ddmBlackOverlayColor
        ...
        lhsAddBtn.heightAnchor.constraint(equalToConstant: 16).isActive = true //ori 30
        lhsAddBtn.widthAnchor.constraint(equalToConstant: 16).isActive = true
