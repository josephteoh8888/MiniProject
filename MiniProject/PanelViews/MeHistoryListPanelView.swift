...
//    
//    func didStartMeHistoryanGesture(ppv : MeHistoryListPanelView)
//    func didEndMeHistoryPanGesture(ppv : MeHistoryListPanelView)
//    func didStartOpenMeHistoryPanel()
//    func didFinishOpenMeHistoryPanel()
//    func didStartCloseMeHistoryPanel(ppv : MeHistoryListPanelView)
//    func didFinishCloseMeHistoryPanel(ppv : MeHistoryListPanelView)
//}
////test > new method with uiscrollview of feedcells
//class MeHistoryListPanelView: PanelView, UIGestureRecognizerDelegate{
////    var panelLeadingCons: NSLayoutConstraint?
////    var currentPanelLeadingCons : CGFloat = 0.0
//    var panel = UIView()
//    var tabDataList = [String]()
//    
//    weak var delegate : MeHistoryPanelDelegate?
//    
...
//
//            if(dist >= distLimit) {
//                self.delegate?.didStartCloseMeHistoryPanel(ppv: self)
//
//            } else {
//                let oriX = width/2 - height/2 //default 200
//                let oriY = viewHeight/2 - height/2
...
//
//                //test
//                self.delegate?.didEndMeHistoryPanGesture(ppv: self)
//            }
//            
//            //test > determine direction of scroll
//            direction = "na"
...
//
//                self.delegate?.didFinishCloseMeHistoryPanel(ppv : self)
//            })
//        } else {
//            //test > stop video before closing panel
//            self.destroyCell()
...
//
//        if(isAnimated) {
//            self.delegate?.didStartOpenMeHistoryPanel()
//
//            offsetX = offX
//            offsetY = offY
//
...
//                
//            }, completion: { finished in
//                self.delegate?.didFinishOpenMeHistoryPanel()
//
//                //test
//                self.initialize()
//            })
...
//}
//
//extension MeHistoryListPanelView: UIScrollViewDelegate {
//    
...
//}
//
//extension MeHistoryListPanelView: ScrollFeedCellDelegate {
...
//}
//
//extension MeHistoryListPanelView: TabStackDelegate {
