//
//  ScrollFeedHNotifyInboxListCell.swift
//  MiniProject
//
...
class ScrollFeedHNotifyInboxListCell: ScrollFeedHNotifyListCell {
...
//    var vDataList = [String]()
    ...
    func redrawUI() {
        ...
        vCV.register(HNotifyInboxListViewCell.self, forCellWithReuseIdentifier: HNotifyInboxListViewCell.identifier)
        vCV.dataSource = self
        vCV.delegate = self
...
extension ScrollFeedHNotifyInboxListCell: UICollectionViewDelegateFlowLayout {
...
//        return CGSize(width: collectionView.frame.width, height: collectionView.frame.height)
        ...
        let messageSenderPhotoHeight = 40.0
...
extension ScrollFeedHNotifyInboxListCell: UICollectionViewDelegate {
...
extension ScrollFeedHNotifyInboxListCell: UICollectionViewDataSource {
