//
//  ScrollFeedHNotifyChatListCell.swift
//  MiniProject
//
...
class ScrollFeedHNotifyChatListCell: ScrollFeedHNotifyListCell {
...
//    var vDataList = [String]()
    ...
    func redrawUI() {
        ...
        vCV.register(HNotifyChatListViewCell.self, forCellWithReuseIdentifier: HNotifyChatListViewCell.identifier)
        vCV.dataSource = self
        vCV.delegate = self
...
extension ScrollFeedHNotifyChatListCell: UICollectionViewDelegateFlowLayout {
...
//        return CGSize(width: collectionView.frame.width, height: collectionView.frame.height)
        ...
        let messageSenderPhotoHeight = 50.0
        let messageSenderPhotoTopMargin = 10.0
        let frameBottomMargin = 10.0
        let totalHeight = messageSenderPhotoHeight + messageSenderPhotoTopMargin + frameBottomMargin
...
extension ScrollFeedHNotifyChatListCell: UICollectionViewDelegate {
...
extension ScrollFeedHNotifyChatListCell: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return vDataList.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: HNotifyChatListViewCell.identifier, for: indexPath) as! HNotifyChatListViewCell
        //test > configure cell
