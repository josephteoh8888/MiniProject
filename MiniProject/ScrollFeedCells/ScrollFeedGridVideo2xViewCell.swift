//
//  ScrollFeedGridVideo2xViewCell.swift
//  MiniProject
//
...
class ScrollFeedGridVideo2xViewCell: ScrollDataFeedCell {
...
//        let vCV = UICollectionView(frame: .zero, collectionViewLayout: gridLayout)
        ...
        vCV.register(GridVideo2xViewCell.self, forCellWithReuseIdentifier: GridVideo2xViewCell.identifier)
        vCV.dataSource = self
        vCV.delegate = self
...
extension ScrollFeedGridVideo2xViewCell: UICollectionViewDelegateFlowLayout {
...
extension ScrollFeedGridVideo2xViewCell: UICollectionViewDelegate {
...
extension ScrollFeedGridVideo2xViewCell: UICollectionViewDataSource {
