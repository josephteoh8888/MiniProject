//
//  ScrollFeedHResultMainListCell.swift
//  MiniProject
//
...
class ScrollFeedHResultMainListCell: ScrollFeedHResultListCell {
...
extension ScrollFeedHResultMainListCell: UICollectionViewDelegateFlowLayout {
...
//        return CGSize(width: collectionView.frame.width, height: 150)
        ...
        if(data == "a") {
            ...
            sumHeight = contentHeight + miscHeight
        } else if (data == "b") {
            ...
            let videoHeight = 90.0
            let videoTopMargin = 10.0 //10
            let frameBottomMargin = 10.0 //10
            sumHeight = videoHeight + videoTopMargin + frameBottomMargin
        } else if (data == "d") {
            let userPhotoHeight = 40.0
            let userPhotoTopMargin = 10.0 //10
            let frameBottomMargin = 10.0 //10
        ...
        return CGSize(width: collectionView.frame.width, height: sumHeight)
...
extension ScrollFeedHResultMainListCell: UICollectionViewDelegate {
...
extension ScrollFeedHResultMainListCell: UICollectionViewDataSource {
